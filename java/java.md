...
A differenza di altri linguaggi, Java costringe il programmatore a gestire certi tipi di eccezioni al tempo di compilazione (le **checked** o controllate, appunto). Se vengono sollevate all'interno di un metodo, devono essere ivi gestite o dichiarate nella clausola `throws`.
