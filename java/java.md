...
Infine, una mappa è molto utile se si deve creare una look up table, ed è veloce come un array, essendo, dal punto di vista logico, una sua generalizzazione in cui gli indici non devono essere per forza degli interi.
