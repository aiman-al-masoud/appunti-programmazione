...
A differenza di altri linguaggi, Java costringe il programmatore a gestire certi tipi di eccezioni (le **checked** o controllate, appunto) al tempo di compilazione.
