...
Sono entrambe implementazioni dell'interfaccia `List`. Una lista in generale non ha una dimensione fissa, anzi, può variare al runtime. E può anche contenere elementi di tipo disomogeneo.
