...
I generics sono uno strumento per definire delle classi che accettano parametri di tipo generico, e specificare quando ne si crea un oggetto il tipo particolare che accetteranno. 
