...
Se un'eccezione non viene catturata, il programma uscirà dall'attuale blocco di codice, verso il blocco esterno o chiamante. Se non viene catturata in nessun blocco di codice esterno, l'eccezione finirà per terminare il programma con un errore.
