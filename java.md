...
Capita spesso di dover passare un oggetto come argomento ad un metodo. Spesso, il tipo richiesto dal metodo è un'interfaccia. Ma le interfacce non possono essere implementate, dato che sono incomplete. Dovremmo dunque creare una nuova classe che implementa l'interfaccia, scrivere il corpo dei metodi e poi creare un'istanza della nostra classe per passarla al metodo.
