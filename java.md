...
I package servono a organizzare il codice ed evitano le collisioni in caso di classi con lo stesso nome, permettendo di usarle tutte nello stesso file. Usando un IDE Eclipse potremo creare nuovi packages dal menù Package Explorer:
